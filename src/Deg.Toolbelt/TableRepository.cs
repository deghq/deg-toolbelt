...
namespace Deg.Toolbelt
{
	...
	{
//		SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings[ConfigurationManager.AppSettings["database"]].ConnectionString);
		SqlConnection con;
		
		public TableRepository(string database)
		{
			if (database != "") {
